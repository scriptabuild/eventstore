...
let store = initStore(folder, createContactlistFn /*, stopReplayPredicate*/);
...
store.withRetries((contactlist, rollback) => {
	contactlist.addContact({name: "Donald Duck", city: "Duckburgh", species: "Duck"});
	contactlist.removeContact("Goofey");
});
